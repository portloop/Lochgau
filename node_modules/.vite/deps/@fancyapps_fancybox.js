...
(function(window2, document2, $, undefined2) {
  ...
  $.extend(FancyBox.prototype, {
    ...
    init: function() {
      ...
      if (!$.fancybox.getInstance() && firstItemOpts.hideScrollbar !== false && !$.fancybox.isMobile && document2.body.scrollHeight > window2.innerHeight) {
        $("head").append(
    ...
    addEvents: function() {
      ...
      if (self.group[self.currIndex].opts.idleTime) {
        ...
        self.idleInterval = window2.setInterval(function() {
    ...
    removeEvents: function() {
      ...
      if (self.idleInterval) {
        window2.clearInterval(self.idleInterval);
    ...
    setBigImage: function(slide) {
      var self = this, img = document2.createElement("img"), $img = $(img);
    ...
    setIframe: function(slide) {
      ...
      slide.$iframe = $iframe = $(opts.tpl.replace(/\{rnd\}/g, (/* @__PURE__ */ new Date()).getTime())).attr(opts.attr).appendTo(slide.$content);
      if (opts.preload) {
        self.showLoading(slide);
    ...
    updateControls: function() {
      ...
      if ($(document2.activeElement).is(":hidden,[disabled]")) {
        self.$refs.container.trigger("focus");
      }
    },
...
(function(window2, document2, $) {
  ...
  Guestures.prototype.ontouchstart = function(e) {
    ...
    self.startTime = (/* @__PURE__ */ new Date()).getTime();
    ...
    $(document2).off(".fb.touch").on(isTouchDevice ? "touchend.fb.touch touchcancel.fb.touch" : "mouseup.fb.touch mouseleave.fb.touch", $.proxy(self, "ontouchend")).on(isTouchDevice ? "touchmove.fb.touch" : "mousemove.fb.touch", $.proxy(self, "ontouchmove"));
    if ($.fancybox.isMobile) {
      document2.addEventListener("scroll", self.onscroll, true);
    }
    ...
    if (self.startPoints.length === 2 && current.type === "image" && (current.isLoaded || current.$ghost)) {
      ...
      self.isZooming = true;
      $.fancybox.stop(self.$content);
      self.centerPointStartX = (self.startPoints[0].x + self.startPoints[1].x) * 0.5 - $(window2).scrollLeft();
      self.centerPointStartY = (self.startPoints[0].y + self.startPoints[1].y) * 0.5 - $(window2).scrollTop();
  ...
  Guestures.prototype.onscroll = function(e) {
    ...
    document2.removeEventListener("scroll", self.onscroll, true);
  };
    ...
    if (swiping === true) {
      if (Math.abs(self.distance) > 10) {
        ...
        if (instance.group.length < 2 && self.opts.vertical) {
          self.isSwiping = "y";
        } else if (instance.isDragging || self.opts.vertical === false || self.opts.vertical === "auto" && $(window2).width() > 800) {
          self.isSwiping = "x";
        } else {
  ...
  Guestures.prototype.onZoom = function() {
    ...
    var centerPointEndX = (self.newPoints[0].x + self.newPoints[1].x) / 2 - $(window2).scrollLeft();
    var centerPointEndY = (self.newPoints[0].y + self.newPoints[1].y) / 2 - $(window2).scrollTop();
  ...
  Guestures.prototype.ontouchend = function(e) {
    ...
    self.dMs = Math.max((/* @__PURE__ */ new Date()).getTime() - self.startTime, 1);
  ...
  Guestures.prototype.onTap = function(e) {
    ...
    var tapX = endPoints[0] ? endPoints[0].x - $(window2).scrollLeft() - self.stagePos.left : 0;
    var tapY = endPoints[0] ? endPoints[0].y - $(window2).scrollTop() - self.stagePos.top : 0;
    var where;
...
(function(document2, $) {
  ...
  $(document2).on("visibilitychange", function() {
    var instance = $.fancybox.getInstance(), SlideShow2 = instance && instance.SlideShow;
    if (SlideShow2 && SlideShow2.isActive) {
      if (document2.hidden) {
        SlideShow2.clear();
      } else {
...
(function(document2, $) {
  ...
  $.extend(FancyThumbs.prototype, {
    ...
    create: function() {
      ...
      if (self.opts.axis === "x") {
        self.$list.width(
          parseInt(self.$grid.css("padding-right"), 10) + instance.group.length * self.$list.children().eq(0).outerWidth(true)
        );
      }
    },
...
(function(window2, document2, $) {
  ...
  function parseUrl() {
    var hash = window2.location.hash.substr(1), rez = hash.split("-"), index = rez.length > 1 && /^\+?\d+$/.test(rez[rez.length - 1]) ? parseInt(rez.pop(-1), 10) || 1 : 1, gallery = rez.join("-");
    return {
      hash,
...
//# sourceMappingURL=@fancyapps_fancybox.js.map
