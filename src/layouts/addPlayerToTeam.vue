    ...
    <div class="main-container">
        ...
        <div class="register-form">
            ...
            <div class="profile-info">
                ...
                <div class="fields-container">
                    <label for="date" class="block mb-2 text-sm  font-medium text-gray-900 dark:text-white">Datum der
                        Geburt
                    </label>
                ...
                <div class="field mb-2 fields-container">
                    <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wählen
                        Sie
                        ein Team</label>
