    ...
    <div class="main-container">
        ...
        <div class="register-form">
            ...
            <div class="profile-info">
                ...
                <div class="field mb-2 fields-container">
                    <label for="role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Funktion</label>
...
export default {
    ...
    axios.get(`http://149.100.159.188/users/list/${userID}`)
        .then((response) => {
            ...
            // Перевірка на наявність об'єкта response.data
            if (response.data) {
                ...
                this.dateOfBirth = response.data.dateOfBirth.substring(0, 10);
