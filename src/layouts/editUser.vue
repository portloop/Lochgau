...
export default {
    ...
    methods: {
        async getTeams() {
            try {
                const response = await axios.get('https://194.15.113.90/api/teams');
    ...
    axios.get(`https://194.15.113.90/users/list/${userID}`)
        .then((response) => {
        ...
        sendData() {
            ...
            axios.put(`https://194.15.113.90/users/list/${userID}`, userData)
                .then(response => {
