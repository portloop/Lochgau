            ...
            <div class="content-container ">
                <div class="preview-table bg-gray-100">
                    ...
                    <button type="button" @click="sendData"
                        class="text-white  field bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add</button>
...
export default {
    ...
    methods: {
        ...
        sendData() {
            axios.post('http://yourufx.space/players/add', {
