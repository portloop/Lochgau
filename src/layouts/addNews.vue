<template>
    ...
    <div class="content-container">
        ...
        <div class="form">
            ...
            <div class="form-title text-3xl mb-3">Add news:</div>
            ...
            <form class="w-full mx-auto mb-6">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="user_avatar">Upload video:
                </label>
                <input
    ...
    methods: {
        ...
        async onUploadImg(files, callback) {
            try {
                const promises = files.map((file) => {
                    ...
                    return axios.post('https://yourufx.space/api/news/upload', form, {
                        headers: {
        ...
        uploadVideo(event) {
            ...
            axios.post(`https://yourufx.space/api/${folder}/upload`, formData, {
                ...
                // this.text += `![Video](https://yourufx.space${videoUrl})\n`;
            }).catch(error => {
        ...
        seendDataToDb() {
            axios.post('https://yourufx.space/api/news', {
                title: this.title,
