...
export default {
    ...
    methods: {
        async fetchPlayers() {
            try {
                const response = await axios.get('http://yourufx.space/users/list');
        ...
        deletePlayer(event) {
            ...
            axios.delete(`http://yourufx.space/users/list/${dataIdValue}`)
                .then((response) => {
        ...
        generateLink () {
            axios.get('http://yourufx.space/generate-link')
            .then((response) => {
