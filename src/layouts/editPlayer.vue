...
export default {
    ...
    methods: {
        ...
        getPlayerData() {
            ...
            axios.get(`https://194.15.113.90/players/${playerId}`)
                .then((response) => {
        ...
        updatePlayerData() {
            ...
            axios.put(`https://194.15.113.90/players/${playerId}`, updatedData)
                .then(response => {
        ...
        deletePlayerById() {
            ...
            axios.delete(`https://194.15.113.90/players/${playerId}`)
                .then((response) => {
