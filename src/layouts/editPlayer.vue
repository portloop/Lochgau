...
export default {
    ...
    methods: {
        ...
        getPlayerData() {
            ...
            axios.get(`http://yourufx.space/players/${playerId}`)
                .then((response) => {
        ...
        updatePlayerData() {
            ...
            axios.put(`http://yourufx.space/players/${playerId}`, updatedData)
                .then(response => {
        ...
        deletePlayerById() {
            ...
            axios.delete(`http://yourufx.space/players/${playerId}`)
                .then((response) => {
