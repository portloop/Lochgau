            ...
            <div class="player-list-container">
                <div class="mb-2 field">
                    <label for="base-input"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name der Mannschaft</label>
                ...
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Neu hinzufügen
            </button>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        createNew () {
            axios.post('http://yourufx.space/api/teams', {
                name: this.name
            })
            .then((response) => {
